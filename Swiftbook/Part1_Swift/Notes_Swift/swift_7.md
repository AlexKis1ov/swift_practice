...
❗️ Если бы свойство rectangle было бы коснтантой, то вызов метода scale вызвал бы ошибку. При изменении свойств стурктуры свойство экземпляра должно быть переменной (var)